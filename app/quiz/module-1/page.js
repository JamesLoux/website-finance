...
const questions = [
  {
    ...
    answer: 1,
    explanation: <>Les incréments sont centrés (pas de drift) et de variance égale à la durée de l&apos;intervalle <Katex>{'u'}</Katex>.</>,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    choices: [
      ...
      <><Katex>{'V_0 = e^{-rT} \\, \\mathbb{E}^{\\mathbb{Q}}[V_T]'}</Katex></>,
      <><Katex>{'V_0 = e^{-rT} \\, \\mathbb{E}^{\\mathbb{P}}[V_T]'}</Katex></>,
    ],
    answer: 2,
